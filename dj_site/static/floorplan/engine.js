    ...
    if (mode == 'object_mode') {
      ...
      if (typeof(binder) == 'undefined') {
        ...
        if (modeOption == 'simpleStair') {
            ...
            allAgents.set(binder.type, snap);
        }
        else {
        ...
        if (wallSelect = editor.nearWall(snap)) {
            ...
            if (wall.type != 'separate') {
              if (typeof(binder) == 'undefined') {
                ...
                allAgents.set(binder.type, wallSelect);
              ...
              if (objTarget !== false) {
                ...
                if (objTarget.params.bindBox) { // OBJ -> BOUNDINGBOX TOOL
                  if (typeof(binder) == 'undefined') {
                    ...
                    allAgents.set(objTarget.type, objTarget.bbox.origin);
                  ...
                  if (typeof(binder) == 'undefined') {
                    ...
                    allAgents.set(objTarget.type, objTarget);
                    binder.update();
            ...
            if (binder.type == 'segment') {
              ...
              if (found) {
                ...
                if (objWall.length > 0) $('#separate').hide();
                  ...
                  $('#rangeThick').show();
                  $('#recombine').hide();
                  document.getElementById('titleWallTools').textContent = "Modify the path";
                  $('#boxinfo').html('Modify the path');
                }
                $('#wallTools').show(200);
                document.getElementById('wallWidth').setAttribute('min', 2);
                document.getElementById('wallWidth').setAttribute('max', 50);
                document.getElementById('wallWidthScale').textContent = "2-50";
