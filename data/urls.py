...
urlpatterns = [
    ...
    path('purchasingitemsupplier', PurchasingItemSupplier.as_view(), name='data-PurchasingItemSupplier'),
    path('purchasingorder', PurchasingOrder.as_view(), name='data-PurchasingOrder'),
    path('purchasingordersummary', PurchasingOrderSummary.as_view(), name='data-PurchasingOrderSummary'),
    path('purchasingsupplier', PurchasingSupplier.as_view(), name='data-PurchasingSupplier'),
    path('capacityproblem', CapacityProblem.as_view(), name='data-CapacityProblem'),
    path('capacityresource', CapacityResource.as_view(), name='data-CapacityResource'),
    path('capacityresourcedetail', CapacityResourceDetail.as_view(), name='data-CapacityResourceDetail'),
    path('capacityresourcereport', CapacityResourceReport.as_view(), name='data-CapacityResourceReport'),
    path('capacityresourceskill', CapacityResourceSkill.as_view(), name='data-CapacityResourceSkill'),
    path('capacitysetupmatrix', CapacitySetupMatrix.as_view(), name='data-CapacitySetupMatrix'),
    path('capacityskills', CapacitySkills.as_view(), name='data-CapacitySkills'),
